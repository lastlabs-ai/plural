...
Run it with::
    ...
    python -m plural.catalog.sync --check
    python -m plural.catalog.sync --write --report catalog-report.md
    python -m plural.catalog.sync --write --add openai/gpt-5.6-luna
"""
...
# Mirrors plural.client env handling so the sync sees the same providers.
