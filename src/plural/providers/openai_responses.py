...
of it back to the same :class:`~plural.types.StreamChunk` every other provider
...
from plural.providers.base import (
    aiter_sse_lines,
...
from plural.providers.openai_compatible import HostQuirks, OpenAICompatible
from plural.providers.structured import structured_schema, wants_json_object
...
class OpenAIResponsesProvider(OpenAICompatible):
    ...
    def _chunk_from_event(
        ...
        Raises:
            PluralError: When the endpoint reports the response failed.
        """
