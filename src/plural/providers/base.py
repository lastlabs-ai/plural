...
Examples:
    >>> from plural.providers.base import ProviderConfig
...
def classify_http_error(
    *,
    ...
    return PluralError(message, **kwargs)
...
def map_transport_error(exc: Exception, *, provider: str, model: str | None = None) -> PluralError:
    ...
    return PluralError(str(exc), provider=provider, model=model)
