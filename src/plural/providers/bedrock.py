...
Examples:
    >>> from plural.providers.bedrock import bedrock_endpoint
...
from plural.catalog.models import normalize_region
from plural.errors import ConfigurationError, PluralError
...
from plural.providers.structured import (
...
class EventStreamDecoder:
    ...
    def feed(self, data: bytes) -> Iterator[tuple[dict[str, str], bytes]]:
        ...
        Raises:
            PluralError: If a frame declares an implausible length.
        """
