...
from plural.tracing.schema import Outcome, Trace
from plural.tracing.sinks import Sink
...
class TraceWriter:
    ...
    def __init__(
        ...
        *,
        ...
        self._thread = threading.Thread(target=self._run, name="plural-trace-writer", daemon=True)
        self._closed = False
        self._thread.start()
